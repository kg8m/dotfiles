...
def DefineRawList(): void
  ...
  raw_list = [
    ...
    ["[SimpleAlign] \"=>\"",         "'<,'>silent SimpleAlign => -count 1"],
    ["[SimpleAlign] \"+=\"",         "'<,'>silent SimpleAlign [\\ +]= -count 1"],
    ["[SimpleAlign] /\\S/",          "'<,'>silent SimpleAlign \\S\\+ -lpadding 0"],
    ["[SimpleAlign] /\\S/ once",     "'<,'>silent SimpleAlign \\S\\+ -lpadding 0 -count 1"],
    ["[SimpleAlign] /\\S/ twice",    "'<,'>silent SimpleAlign \\S\\+ -lpadding 0 -count 2"],
    ["[SimpleAlign] \":foo\"",       "'<,'>silent SimpleAlign : -rpadding 0"],
    ["[SimpleAlign] \"foo:\"",       "'<,'>silent SimpleAlign [^:\\ ]\\+:\\(:\\)\\@!"],
    ["[SimpleAlign] \"foo:\" once",  "'<,'>silent SimpleAlign [^:\\ ]\\+:\\(:\\)\\@! -count 1"],
    ["[SimpleAlign] \"foo:\" twice", "'<,'>silent SimpleAlign [^:\\ ]\\+:\\(:\\)\\@! -count 2"],
    ["[SimpleAlign] \"|\"",          "'<,'>silent SimpleAlign |"],
    ["[SimpleAlign] \")\"",          "'<,'>silent SimpleAlign ) -lpadding 0"],
    ["[SimpleAlign] \"]\"",          "'<,'>silent SimpleAlign ] -lpadding 0"],
    ["[SimpleAlign] \"}\"",          "'<,'>silent SimpleAlign }"],
    ["[SimpleAlign] \"  # \"",       "'<,'>silent SimpleAlign # -lpadding 2"],
    ["[SimpleAlign] \"  // \"",      "'<,'>silent SimpleAlign // -lpadding 2"],
    ["[SimpleAlign] \"  #=> \"",     "'<,'>silent SimpleAlign #=> -lpadding 2"],
    ["[SimpleAlign] \"  //=> \"",    "'<,'>silent SimpleAlign //=> -lpadding 2"],

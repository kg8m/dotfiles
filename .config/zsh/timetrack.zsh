...
TIMETRACK_PATTERN+="|\bmise (doctor|exec|install|latest|list|ls-remote|outdated|reshim|run|self-update|uninstall|upgrade|use)\b"
...
TIMETRACK_PATTERN+="|\btools:install:latest\b"

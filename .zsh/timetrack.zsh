...
TIMETRACK_IGNORE_PATTERN="$TIMETRACK_IGNORE_PATTERN|\bg(it)? (add|ca|ci|commit\b|d|l|open-changed-files|revert|show)"
TIMETRACK_PATTERN="^$"
...
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\bconfigure\b"
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\bfor\b"
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\bgo\b"
...
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\b(rails|rake) stats\b"
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\brbenv\b"
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\brsync\b"
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\brubocop(-daemon)?\b"
...
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\bwebpack\b"
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|\byarn\b"
...
TIMETRACK_PATTERN="$TIMETRACK_PATTERN|^g(it)? "

...
alias rake_units='      execute_with_echo "TEST_ENV_NUMBER=2 prepare; TEST_ENV_NUMBER=2 rake test:separate:units $1"'
alias rake_functionals='execute_with_echo "TEST_ENV_NUMBER=3 prepare; TEST_ENV_NUMBER=3 rake test:separate:functionals $1"'
alias rake_integration='execute_with_echo "TEST_ENV_NUMBER=4 prepare; TEST_ENV_NUMBER=4 rake test:separate:integration $1"'
